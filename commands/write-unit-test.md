...
5. **Rules**:
   - Unit tests are independent to each others.
   - Ultilize same logic test with multiple parameters (parametrizing) as test cases.
6. **Verify improvement**: Run coverage again, confirm measurable increase
