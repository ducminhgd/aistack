...
Personas define the character, values, and decision-making style that an agent
adopts when assisting with a task. They complement skills (which define *what*
to do) by defining *how* the agent thinks, prioritises, and communicates.
